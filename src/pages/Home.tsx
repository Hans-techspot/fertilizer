  ...
  const products = [
    {
      ...
      description: 'Top quality fertilizer for sale. Sodium Molybdate, Dihydrate is used in the manufacturing of inorganic and organic pigments.',
    ...
    },
    {
      ...
      description: 'Copper(II) sulfate, also known as copper sulphate, is an inorganic compound with the chemical formula CuSO4.',
      category: 'Micronutrients',
    },
    {
      id: 3,
      ...
      description: 'Fertiliser for sale. Zinc Sulfate Heptahydrate is a moderately water and acid soluble Zinc source.',
      category: 'Micronutrients',
    },
    {
      id: 4,
      ...
      description: 'Ferric DTPA is a pure liquid Iron fertilizer. Iron DTPA is adviced for hydroponics.',
      category: 'Chelates',
    },
    {
      id: 5,
      ...
      description: 'Buy Urea Fertiliser online. Urea, also known as carbamide, is an organic compound with the chemical formula CO(NH2)2.',
      category: 'Nitrogen',
    },
    {
      id: 6,
      ...
      description: 'Monopotassium phosphate (MKP) is the inorganic compound with the formula KH2PO4.',
      category: 'Phosphorus',
    },
  ]
